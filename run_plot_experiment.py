...
def run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=5, HTB_NORMAL = 10):
    ...
    WAY_NUM = 5
    GPU_MODE = 'True'
    LOG_DIR = 'plot_experiment_results_1'
    PRE_TRA_DROP = 0.9
    SAVE_STEP = 1000
    LR_DROP_STEP = 1000
    META_LR = 0.001 
...
run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='False', DATASET='mini', PHASE='META', HTB_HARD=1, HTB_NORMAL = 20)

run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='False', DATASET='tiered', PHASE='META', HTB_HARD=1, HTB_NORMAL = 20)
