...
run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet18', MTL='True', DATASET='mini', PHASE='META')

run_exp(SHOT_NUM=1, HEAD='cosine', BACKBONE='resnet18', MTL='True', DATASET='mini', PHASE='META')

run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet18', MTL='True', DATASET='tiered', PHASE='META')

run_exp(SHOT_NUM=1, HEAD='cosine', BACKBONE='resnet18', MTL='True', DATASET='tiered', PHASE='META')
