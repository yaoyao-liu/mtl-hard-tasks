...
def run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=5, HTB_NORMAL=10):
    GPU_ID = 0
...
run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=2, HTB_NORMAL=10)
run_exp(SHOT_NUM=5, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=2, HTB_NORMAL=10)

run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=10, HTB_NORMAL=20)
run_exp(SHOT_NUM=5, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=10, HTB_NORMAL=20)

run_exp(SHOT_NUM=1, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=10, HTB_NORMAL=40)
run_exp(SHOT_NUM=5, HEAD='fc', BACKBONE='resnet12', MTL='True', DATASET='mini', PHASE='META', HTB_HARD=10, HTB_NORMAL=40)
