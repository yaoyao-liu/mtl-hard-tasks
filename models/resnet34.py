...
class Models:
    ...
    def forward_pretrain_resnet(self, inp, weights, reuse=False, scope=''):
        ...
        net = self.pretrain_block_forward(net, weights, 'block1_2', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block1_3', reuse, scope, block_last_layer=True)

        net = self.pretrain_block_forward(net, weights, 'block2_1', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block2_2', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block2_3', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block2_4', reuse, scope, block_last_layer=True)

        net = self.pretrain_block_forward(net, weights, 'block3_1', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block3_2', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block3_3', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block3_4', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block3_5', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block3_6', reuse, scope, block_last_layer=True)

        net = self.pretrain_block_forward(net, weights, 'block4_1', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block4_2', reuse, scope)
        net = self.pretrain_block_forward(net, weights, 'block4_3', reuse, scope, block_last_layer=True)
    ...
    def forward_resnet(self, inp, weights, ss_weights, reuse=False, scope=''):
        ...
        net = self.block_forward(net, weights, ss_weights, 'block1_2', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block1_3', reuse, scope, block_last_layer=True)

        net = self.block_forward(net, weights, ss_weights, 'block2_1', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block2_2', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block2_3', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block2_4', reuse, scope, block_last_layer=True)

        net = self.block_forward(net, weights, ss_weights, 'block3_1', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block3_2', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block3_3', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block3_4', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block3_5', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block3_6', reuse, scope, block_last_layer=True)

        net = self.block_forward(net, weights, ss_weights, 'block4_1', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block4_2', reuse, scope)
        net = self.block_forward(net, weights, ss_weights, 'block4_3', reuse, scope, block_last_layer=True)
    ...
    def construct_resnet_weights(self):
        ...
        weights = self.construct_residual_block_weights(weights, 3, 64, 64, conv_initializer, dtype, 'block1_3')
        ...
        weights = self.construct_residual_block_weights(weights, 3, 128, 128, conv_initializer, dtype, 'block2_3')
        weights = self.construct_residual_block_weights(weights, 3, 128, 128, conv_initializer, dtype, 'block2_4')
        ...
        weights = self.construct_residual_block_weights(weights, 3, 256, 256, conv_initializer, dtype, 'block3_3')
        weights = self.construct_residual_block_weights(weights, 3, 256, 256, conv_initializer, dtype, 'block3_4')
        weights = self.construct_residual_block_weights(weights, 3, 256, 256, conv_initializer, dtype, 'block3_5')
        weights = self.construct_residual_block_weights(weights, 3, 256, 256, conv_initializer, dtype, 'block3_6')
        ...
        weights = self.construct_residual_block_weights(weights, 3, 512, 512, conv_initializer, dtype, 'block4_3')
    ...
    def construct_resnet_ss_weights(self):
        ...
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 64, 64, 'block1_3')
        ...
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 128, 128, 'block2_3')
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 128, 128, 'block2_4')
        ...
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 256, 256, 'block3_3')
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 256, 256, 'block3_4')
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 256, 256, 'block3_5')
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 256, 256, 'block3_6')
        ...
        ss_weights = self.construct_residual_block_ss_weights(ss_weights, 512, 512, 'block4_3')
